...
import com.example.deepak.ad_farm.data.AdvertiserContract;
import com.example.deepak.ad_farm.data.AdvertiserHelper;
...
public class AdvertiserPostActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advertiser_post);
